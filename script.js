...
const RAW_ITEMS = [
  {id:'book', name:'Book', file:'book.svg'},
  {id:'chair', name:'Chair', file:'chair.svg'},
  {id:'clock', name:'Clock', file:'clock.svg'},
  {id:'comb', name:'Comb', file:'comb.svg'},
  {id:'cup', name:'Cup', file:'cup.svg'},
  {id:'envelope', name:'Envelope', file:'envelope.svg'},
  {id:'fork', name:'Fork', file:'fork.svg'},
  {id:'glasses', name:'Glasses', file:'glasses.svg'},
  ...
  {id:'orange', name:'Orange', file:'orange.svg'},
  ...
  {id:'pineapple', name:'Pineapple', file:'pineapple.svg'},
